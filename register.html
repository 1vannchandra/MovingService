            ...
            <div class="register-box">
                <div>
                    ...
                    <form action="">
                        ...
                        <button class="poppins-regular">CONTINUE</button>
                        <section>
                            <p class="poppins-regular" style="text-align: center; margin: 0 !important;">Already have an Account?</p>
                            <a href="" class="poppins-regular" style="text-decoration: underline;">Login</a>
                        </section>
                    </form>
                </div>
            </div>
